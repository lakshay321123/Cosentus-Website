...
const leadership = [
  ...
  { name: 'Manisha Bhalla', title: 'Chief People Officer', photo: '/images/1Manisha.jpg', bio: 'The Bhalla\'s are a family of 7. GS, Manisha, 2 two-legged and 3 four-legged children. As the Executive Director of Cosentus, she loves the entire team and looks forward to seeing everyone every day — and we all look forward to her around-the-office morning greetings and warm, balancing presence! (She\'s also GS\'s boss!!)' },
  ...
  { name: 'Aman Bhasin', title: 'Sr. VP & Head of Global Operations (Non-US)', photo: '/images/AMAN BHASIN.jpg', bio: 'Aman is our Senior Vice President and Head of Global Operations (Non-US). He oversees all international operations and manages teams across multiple geographies, ensuring consistent service delivery and operational excellence. Aman has been instrumental in scaling Cosentus\'s global capabilities and building high-performing teams that deliver world-class revenue cycle management services to clients across the organization.' },
]
