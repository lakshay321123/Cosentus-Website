...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE}/healthcare-revenue-cycle-management`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${SITE}/in-news`, lastModified: now, changeFrequency: 'weekly', priority: 0.6 },
    { url: `${SITE}/casestudies-wp`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
