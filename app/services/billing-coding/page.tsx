      ...
      <section className="section">
        <div className="container">
          ...
          <div className="advantage-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)', marginTop: 48 }}>
            {[
              { title: 'Dedicated, Specialty-Trained Teams', desc: 'You get named coders and billing leads who understand your clinical workflows and payer rules.', img: '/images/icons/p3-3d.png' },
              { title: 'R+A Accuracy & Scale', desc: 'AI handles verification, follow-up, and collections; human specialists handle complex coding, clinical validation, and denials.', img: '/images/icons/3a.png' },
              { title: 'Proactive Denial Prevention', desc: 'Every claim passes payer-specific edits before submission. Every denied dollar is pursued until collected.', img: '/images/icons/p3-3c.png' },
            ].map((item, i) => (
