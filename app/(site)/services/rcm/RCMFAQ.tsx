...
const rcmFaqs = [
  ...
  { q: 'How do I track and verify performance?',
    a: 'Real-time dashboards segmented by provider, payer, procedure, and denial category, plus weekly check-ins with your account team, monthly operational reviews, and quarterly business reviews. You see every claim status, every denial reason, and every dollar in motion, with no waiting for end-of-month reports.' },
]
