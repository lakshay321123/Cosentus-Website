...
const leadership = [
  ...
  // HIDDEN per user direction (Jun 2026), kept for restore:
  ...
  { name: 'Raja Inder Bhalla', title: 'Managing Director', photo: '/images/Raja-Inder-Bhalla.jpg', bio: 'Meet our Co-Founder & MD of Cosentus India Pvt Ltd, a well-rounded leader. Being from a Finance and International Business background, Raja brings expertise in business operations and an intricate understanding of the ever-changing nature of the service industry. Enjoying the fast-paced nature of Cosentus, he leads our dedicated operations support team in Delhi-NCR and helps clients & employees with winning solutions. Raja and his wife Ashmeen have two children, a daughter Taarini and a son named Jeev. Want to meet an adventurous family? Meet the Bhalla\'s who enjoy golfing, skiing, riding motorcycles, and traveling.' },
  { name: 'Mark Wines', title: 'Chief Growth Officer', photo: '/images/Mark-Wines.jpg' },
