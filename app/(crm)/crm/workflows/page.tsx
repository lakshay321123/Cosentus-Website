    ...
    <div style={{ padding: '36px 44px', maxWidth: '100%', boxSizing: 'border-box' as const }}>
      ...
      {showCreate && (
        <form onSubmit={handleCreate} style={{ background: 'white', borderRadius: 16, border: '1px solid rgba(0,181,214,0.3)', padding: 24, marginBottom: 20 }}>
          ...
          <input name="name" placeholder="Workflow name *" required style={{ width: '100%', padding: '10px 14px', borderRadius: 10, border: 'none', boxShadow: '0 1px 3px #E6E6E6, 0 4px 12px #D6EBF2', fontSize: 13, marginBottom: 12, boxSizing: 'border-box' as const }} />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div style={{ background: '#f7f7f7', borderRadius: 12, padding: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 80px 1fr', gap: 6 }}>
                ...
                <select name="condition_op" style={{ padding: '6px 8px', borderRadius: 4, border: 'none', boxShadow: '0 1px 3px #E6E6E6, 0 4px 12px #D6EBF2', fontSize: 12, background: 'white' }}>
            ...
            <div style={{ background: '#f7f7f7', borderRadius: 12, padding: 16 }}>
              ...
              <input name="action_value" placeholder="Value (rep name, stage, template, etc)" style={{ width: '100%', padding: '8px 12px', borderRadius: 10, border: 'none', boxShadow: '0 1px 3px #E6E6E6, 0 4px 12px #D6EBF2', fontSize: 13, boxSizing: 'border-box' as const }} />
            </div>
          </div>
      ...
      <div style={{ display: 'grid', gap: 10 }}>
        {workflows.map(wf => (
          <div key={wf.id} style={{ background: 'white', borderRadius: 16, border: 'none', boxShadow: '0 1px 3px #E6E6E6, 0 4px 12px #D6EBF2', padding: '20px 24px', display: 'flex', alignItems: 'center', gap: 20 }}>
