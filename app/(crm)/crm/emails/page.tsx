...
export default function EmailsPage() {
  ...
  const toHtml = () => {
    ...
    for (const b of blocks) {
      ...
      if (b.type === 'header') html += `<div style="${bg};${pad};text-align:center"><img src="https://cosentus-website.vercel.app/images/cosentus-logo.png" alt="Cosentus" style="height:28px;margin-bottom:6px"><div style="font-size:11px;letter-spacing:0.15em;color:rgba(255,255,255,0.8)">REAL + ARTIFICIAL INTELLIGENCE</div></div>`
