 ...
 */
export default function ResultsSection({ intro = false, showArrows = false }: { intro?: boolean; showArrows?: boolean }) {
  return (
    <section className="results-section" id="results" style={{ overflow: 'hidden' }}>
      <div className="container-wide">
        ...
        <div className="results-mobile" style={{ overflow: "hidden", width: "100%" }}>
          <MobileCarousel autoScrollInterval={3500} showArrows={showArrows}>
            {stats.map((stat, i) => (
