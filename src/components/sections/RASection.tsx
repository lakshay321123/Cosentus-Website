...
const features = [
  { icon: '/images/icons/3a.png', title: 'Scalable AI Built for Growth', desc: 'Enterprise-scale capacity that grows with your practice — processing ~3,000 calls daily.' },
  { icon: '/images/icons/3b.png', title: 'Specialized AI Voice Agents', desc: 'Automate eligibility, claims, prior authorizations, scheduling, and patient billing.' },
  { icon: '/images/icons/p3-3a.png', title: 'Up to 30% Revenue Growth', desc: 'Real results, not just reports. AI-powered insights that drive measurable financial improvement.' },
]
