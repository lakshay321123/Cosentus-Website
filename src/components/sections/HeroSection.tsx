  ...
  return (
    <section className="hero">
      <div className="hero-bg">
        <video key={videoSrc} autoPlay loop muted playsInline style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', transform: 'rotate(180deg)', zIndex: 0 }}>
