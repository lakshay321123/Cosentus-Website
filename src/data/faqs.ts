...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Pricing is a percentage of net collections, so you pay only on dollars actually collected, not on claims submitted. There are no setup fees, no per-claim charges, and no surprise add-ons. The exact percentage depends on your specialty, monthly volume, and the scope of services (billing-only vs full comprehensive RCM vs full practice management). We quote the rate during the Free Revenue Analysis so the number is grounded in your real numbers, not a list price.',
  },
  {
